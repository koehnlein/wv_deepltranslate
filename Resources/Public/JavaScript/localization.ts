  ...
  private initialize(): void {
    ...
    Icons.getIcon('actions-localize', Icons.sizes.large).then((localizeIconMarkup: string): void => {
      Icons.getIcon('actions-edit-copy', Icons.sizes.large).then((copyIconMarkup: string): void => {
        Icons.getIcon('actions-localize-deepl', Icons.sizes.large).then((localizeDeeplIconMarkup: string): void => {
          ...
          $(document).on('click', me.triggerButton, (e: JQueryEventObject): void => {
            ...
            if ($triggerButton.data('allowTranslate')) {
              ...
              actions.push(
                  ...
                  + '</div>'
                  + '<div class="col-sm-9">'
                  + '<p class="t3js-helptext t3js-helptext-translate text-body-secondary">' + TYPO3.lang['localize.educate.deepltranslateAuto'] + '</p>'
                  + '</div>'
                  + '</div>',
              );
              ...
              actions.push(
                  ...
                  + '</div>'
                  + '<div class="col-sm-9">'
                  + '<p class="t3js-helptext t3js-helptext-translate text-body-secondary">' + TYPO3.lang['localize.educate.deepltranslate'] + '</p>'
                  + '</div>'
                  + '</div>',
              );
